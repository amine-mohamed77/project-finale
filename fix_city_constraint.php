...
echo "<h1>Fix Database Constraints</h1>";
...
if (isset($_GET['action'])) {
    ...
    try {
        ...
        } elseif ($action === 'check_form_submission') {
...
try {
    ...
    $house_status_text = $house_count > 0 ? "<span style='color: green;'>OK</span>" : "<span style='color: orange;'>Empty</span>";
    ...
    echo "<tr><td>Houses</td><td>{$house_count}</td><td>{$house_status_text}</td></tr>";
    echo "</table>";
...
echo "<a href='?action=check_form_submission' class='btn'>Test House Insertion</a> ";
