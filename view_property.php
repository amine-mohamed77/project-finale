...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $house_id = $_GET['id'];
    error_log("Using property ID from GET: $house_id");
} elseif (isset($_POST['property_id']) && !empty($_POST['property_id'])) {
    $house_id = $_POST['property_id'];
    error_log("Using property ID from POST: $house_id");
} else {
    error_log("Property ID not set in view_property.php");
...
try {
    ...
    $stmt = $conn->prepare("
        SELECT h.*, c.city_name, pt.proprety_type_name, o.owner_name, o.owner_email, o.owner_id, p.picture_url
        FROM house h
    ...
    $_SESSION['error'] = "Error retrieving property details: " . $e->getMessage();
    header("Location: Profile.php");
    exit();
}
?>
...
<head>
    ...
    <title><?php echo htmlspecialchars($property['house_title']); ?> - UniHousing</title>
    ...
    <style>
        ...
        .thumbnail.active {
            border: 3px solid  rgb(27, 84, 207);;
        }
    ...
    <section class="property-details">
        <div class="container">
            ...
            <div class="property-gallery">
                <div class="main-image">
                    ...
                    <?php if (isset($_SESSION['user_id']) && $_SESSION['user_type'] == 'student'): ?>
                        <?php if ($is_favorite): ?>
                            <a href="javascript:void(0)" class="favorite-btn active" title="Already in favorites">
                                <i class="fas fa-heart"></i>
                            </a>
                        <?php else: ?>
                            <a href="javascript:void(0)" class="favorite-btn" title="Add to favorites">
            ...
            <div class="property-info">
                <div class="property-header">
                    ...
                    <div class="price-section">
                        ...
                        <?php if (isset($_SESSION['user_id']) && $_SESSION['user_type'] == 'student'): ?>
                            <a href="chat.php?owner_id=<?php echo htmlspecialchars($property['owner_id']); ?>&student_id=<?php echo htmlspecialchars($_SESSION['user_id']); ?>" class="btn btn-primary">Chat with Owner</a>
                        <?php else: ?>
                            <a href="login.php" class="btn btn-primary">Login to Chat</a>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="property-features">
                    ...
                    <?php if(isset($property['house_surface']) && !empty($property['house_surface'])): ?>
                    <div class="feature">
                ...
                <div class="owner-info">
                    ...
                    <div class="owner-card">
                        <?php if (isset($property['picture_url']) && !empty($property['picture_url'])): ?>
                            <img src="<?php echo htmlspecialchars($property['picture_url']); ?>" alt="Owner Photo">
                        <?php else: ?>
            ...
            <div class="back-link" style="margin-top: 20px;">
                <a href="Profile.php#favorites" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Back to Profile</a>
            </div>
        </div>
    </section>
